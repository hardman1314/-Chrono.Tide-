# Chrono Tide 
<img width="280px" height="280px" alt="1777655558716" src="https://github.com/user-attachments/assets/4a8131f1-fed0-43bd-bea7-2ce676d2dce5" />
...
- **Locale Emulator 转区** - 日文游戏一键转区启动- **区域模拟器转区**- 日文游戏一键转区启动- **区域模拟器转区**- 日文游戏一键转区启动-**区域模拟器转区**- 日文游戏一键转区启动
- **主题系统** - 亮色/暗色/自定义背景图切换
- **元数据聚合** - 内嵌 LunaMetadataSDK，支持 VNDB/Bangumi/Steam/Ymgal/DLsite/ErogameScape 六大数据源

## 预览图

<img width="1265" height="711" alt="image" src="https://github.com/user-attachments/assets/ddec6d52-8aa0-4419-8f9e-15751354588c" />


<img width="1264" height="710" alt="image" src="https://github.com/user-attachments/assets/6ec33654-fe80-49c6-a8db-cc4e15126204" />
...
- [LunaBox](https://github.com/Saramanda9988/LunaBox) - 成熟的视觉小说管理工具
